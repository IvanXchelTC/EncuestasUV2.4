...
<html>
  ...
  <title>Encuesta Egresados 2 </title>
...
<body><header class="clearfix">
  ...
  <h1>Encuesta Seguimiento a recien egresados</h1>
  <form action="GUARDAR" method="post">
             <div class="col-2">
            <label>
           Nombre:<input type="text" name="nombre"><br/></label>
            </div>
           <div class="col-2">
            <label>
           Carrera de la que egreso:<input type="text" name="carrera"><br/></label>
            </div>
           <div class="col-2">
            <label>
           Nombre de la empresa o institucion de la que labora:<input type="text" name="empresa"><br/></label>
            </div>
           <div class="col-2">
            <label>
           Domicilio de la empresa:<input type="text" name="domicilioE"><br/></label>
            </div>
             <div class="col-2">
            <label>
           Puesto que desempeña el egresado dentro de la empresa o institucion:
            <input type="text" name="puesto"><br/></label>
            </div>
        ...
        <form action="primera" method="post">
           ...
           <input type="radio" name="option" value="1" id="radio1"checked/>
            <label for="radio1">SI</label><br /><br /></div>
             <div class="estilo2">
            <input type="radio" name="option" value="2" id="radio2"checked/>
            <label for="radio2">NO</label><br /><br /></div>
            <input type="submit" value="Terminar"> 
            </label>
            </div>
       </form>
       ...
       <form action="cuarta" method="post">  
        ...
        <form action="sexto" method="post">
            ...
            <input type="submit" value="Terminar"> </label>
            </div>
        </form>
